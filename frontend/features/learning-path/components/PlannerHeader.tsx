    ...
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <div className="relative mt-1 flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="rounded-full border px-3 py-1 text-xs font-semibold text-primary-600 transition hover:bg-primary-50 focus:outline-none focus:ring-2 focus:ring-primary-500/40"
          ...
          {switcherOpen ? (
            <div
              ...
              className="absolute left-0 top-full z-30 mt-2 w-72 rounded-2xl border bg-white p-2 shadow-xl"
              style={{ borderColor: "var(--border)" }}
            >
      ...
      <div className="flex flex-wrap items-center gap-2">
        <Link
          ...
          className="rounded-xl border px-4 py-2 text-sm font-semibold text-primary-600 transition hover:bg-primary-50"
          style={{ borderColor: "var(--border)" }}
        >
          Optimize plan
        </Link>
