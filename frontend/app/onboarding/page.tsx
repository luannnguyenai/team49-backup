...
const STEP_VALIDATION_FIELDS: (keyof OnboardingFormData)[][] = [
  ...
  ["desired_section_ids"],                           // Step 2: required
  ["available_hours_per_week", "target_deadline"],   // Step 3: required
  ["preferred_method"],                              // Step 4: required
  [],                                                // Step 5: PlacementTest — no form fields
];
