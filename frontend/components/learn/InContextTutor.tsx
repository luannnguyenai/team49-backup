...
export default function InContextTutor({
  ...
  return (
    <div className="flex h-full flex-col bg-surface-page text-text-strong">
      {/* Header */}
      <div
        className="shrink-0 border-b border-border-subtle bg-white/80 px-4 py-3 backdrop-blur"
      >
              ...
              {msg.role === "ai" && msg.id && msg.content && !msg.isPending && (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-auto rounded p-1 text-amber-500 transition-colors hover:bg-amber-50 hover:text-amber-600"
                  >
            ...
            <div className="flex min-w-0 items-center gap-2">
              ...
              >
                <button
                  ...
                  className="inline-flex h-[29px] max-w-[150px] items-center gap-1.5 rounded-full border border-primary-200 bg-surface-accent-soft px-2.5 text-[11px] font-medium text-primary-700 transition hover:border-primary-300 disabled:cursor-not-allowed disabled:opacity-60"
