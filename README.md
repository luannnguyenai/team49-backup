<div align="center">
  ...
  **AI Adaptive Learning Platform — cá nhân hóa lộ trình học cho từng học sinh dựa trên năng lực thực tế.**
  ...
  [**🚀 Live Demo**](https://a20-app-049.io.vn) · [**📐 Architecture**](architecture/) · [**📄 Technical Report**](TECHNICAL_REPORT.md) · [**🤖 AI Logs**](docs/ai-logs.md) · [**📊 Evaluation**](docs/evaluation-report.md) · [**📝 Worklog**](docs/WORKLOG.md)
