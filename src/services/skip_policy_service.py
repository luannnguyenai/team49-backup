...
def can_skip_unit(
    *,
    ...
    return (mastery_lcb is not None and mastery_lcb >= MASTERY_SKIP_LCB_THRESHOLD) or (
        skip_quiz_score is not None and skip_quiz_score >= SKIP_VERIFICATION_SCORE_THRESHOLD
    )
