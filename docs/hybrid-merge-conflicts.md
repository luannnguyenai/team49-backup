...
- Add a dedicated hybrid migration to enable `vector` extension on top of the current hybrid Alembic head
...
- enabling the extension in a dedicated migration captures the safe part without importing the LMS-shaped schema changes
