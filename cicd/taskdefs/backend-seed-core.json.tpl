  ...
  "containerDefinitions": [
    {
      ...
      "command": [
        "sh",
        "-lc",
        "set -euo pipefail; uv run python scripts/materialize_canonical_bundle.py --s3-uri \"$CANONICAL_BUNDLE_S3_URI\" --output-dir \"$CANONICAL_BUNDLE_LOCAL_DIR\"; uv run python scripts/seed.py --input-dir \"$CANONICAL_BUNDLE_LOCAL_DIR\""
      ],
      "environment": [
